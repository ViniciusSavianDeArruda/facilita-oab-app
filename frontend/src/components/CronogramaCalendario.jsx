...
export default function CronogramaCalendario({ onBack, onGoto }) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-sand-50">
      <div className="max-w-md mx-auto px-4 pt-6 pb-8 md:max-w-[950px] md:ml-8 md:mr-0 md:px-8 md:py-10">
        ...
        <div className="bg-ink-950 border border-ink-800 rounded-3xl shadow-[0_10px_35px_rgba(42,36,34,0.04)] p-6 md:p-10">
          <div className="flex items-start justify-between gap-6 flex-wrap mb-8">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    onClick={() => mudarMes(-1)}
                    disabled={!podeVoltar}
                    className="w-8 h-8 rounded-full border border-ink-800 text-cream-400 hover:text-cream-50 hover:border-brass-dim disabled:opacity-30 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
                  ...
                  <button
                    onClick={irParaHoje}
                    className="h-8 px-3 rounded-full border border-ink-800 text-xs text-cream-400 hover:text-cream-50 hover:border-brass-dim transition-colors"
                  >
                    Hoje
                  </button>
                </div>
            ...
            <div className="flex items-center gap-4 shrink-0">
              ...
              <div className="w-px h-9 bg-ink-800"></div>
              <div className="text-right">
                <p className="text-[10px] tracking-widest uppercase text-cream-600 font-medium mb-1">
                  Desempenho
                </p>
              ...
              {diaInfo ? (
                <div className="bg-ink-900 border border-brass-dim rounded-2xl p-5">
                  <div className="flex items-center justify-between gap-3 mb-3 flex-wrap">
                    ...
                    <span className="text-[11px] font-medium bg-[#F7E4EA] text-brass px-2.5 py-1 rounded-full tabular-nums shrink-0">
